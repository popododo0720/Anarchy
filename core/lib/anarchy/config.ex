defmodule Anarchy.Config do
  ...
  def max_concurrent_agents_for_state(state_name) when is_binary(state_name) do
    ...
    Map.get(
      ...
      Schema.normalize_task_state(state_name),
  ...
  def server_port do
    case Application.get_env(:anarchy, :server_port_override) do
  ...
  defp validate_semantics(settings) do
    cond do
      ...
      settings.tracker.kind not in ["postgres", "memory"] ->
